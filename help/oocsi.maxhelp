...
, 			{
		...
		"parameters" : 		{
			...
			"obj-4::obj-25" : [ "live.text[9]", "live.text", 0 ],
			"obj-4::obj-32" : [ "live.text[8]", "live.text", 0 ],
			"obj-4::obj-33" : [ "live.tab[1]", "live.tab", 0 ],
